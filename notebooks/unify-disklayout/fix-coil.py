...
OLD_ROOT = '/media/sf_Masterarbeit/data/COIL100_halfres_AE_0.1'
NEW_ROOT = '/media/sf_Masterarbeit/data/AE/COIL100_halfres_AE_0.1'
...
for old_csv_path in glob.glob(OLD_ROOT + '/*.csv'):
    csv_data = []
    csv_filename = old_csv_path.split('/')[-1].split('_')[0] + '.csv'
