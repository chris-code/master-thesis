...
% Iterative process
% This procedure can be efficiently done via backprop

% Die Existenz von AEs der Nichtlinearität eines Netzwerks zuzuschreiben ist naheliegend
% AEs reside in low-probability regions in the data manifold
