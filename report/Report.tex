...
\begin{figure}[h!tb]
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        ...
        \caption{Pointwise difference of original and adversarial image, positive part. See appendix \ref{sec:visualizing-diff} for details.}
...
% AE by superposition
% How does all of this compare to panda -> acorn transformation with 1 iteration?
...
% FIXME what about the ..._progress_... sets?
...
% TODO same thing for imagenet-ae-1000. Has clear visual structure, but probably because it only has 1 source image.
...
% State that this should be done for other iteration counts.
...
% Something that might be explored in further work is how AEs generated from training data differ from those spawned from other sources
...
% Plot the distribution of confidences in generated AE batches
