...
\begin{table}[htp]
	...
	\begin{tabular}{|l|l|}
		...
		\hline
	\end{tabular}
	\caption{Generated AE batches and corresponding value of $c$}
...
%% Number of classes
%% Each image contains exatly 1 sign
%% Varying sizes, 15x15 to 250x250 pixels, not square
%% Show some images
%% Unbalanced class frequencies
%% Organization into tracks (30 img/track, at least 9 tracks per class)
%% At least 10% Border around sign, Bounding boxes
%% One difficulty is that some classes are very similar, but illumination, occlusion etc. is vastly different
%%%% Network:
% Preprocessing, input size
% Precalculated features are available but were not used

% TODO
%\section{GTSRB and GTSRB-Net}
% Table summarizing GTSRB
%\section{ImageNet and GoogLeNet}
% I didn't train googlenet myself
% Imagenet is quite organic in nature, but as of the time of this writing it contains X images.
