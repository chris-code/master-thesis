...
% Conclude how this is a bad idea
% Anyway, give some statistics about how good the fit is (MSE) and how far the final confidence prediction deviates from the ground truth (on average).
