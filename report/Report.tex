...
\begin{figure}[htp]
	...
	\caption{Element-wise logarithm of the spectra of ImageNet and imagenet-ae-50, and the difference between them (adversarial - original)}
...
\begin{figure}[htp]
	...
	\caption{Activity distribution in ImageNet and adversarial spectra, w.r.t frequency}
...
\begin{figure}[htp]
	...
	\caption{Activity distribution in ImageNet and adversarial spectra, w.r.t angle}
