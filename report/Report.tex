...
% FIXME references
This algorithm will be used both to create the individual adversarial examples of section \ref{sec:fundamental-properties} and the large amount of AEs described in section \ref{sec:generation-large-sets}, which serve as a basis for the analyses in sections \ref{sec:spectra}, \ref{sec:bar} and \ref{sec:baz}.
...
% TODO Describe what has been done
% TODO source for Levenberg-Marquard algorithm
% FIXME not Levenberg-Marquard anymore with the bounds? Should be Trust region reflective algorithm, but Dogleg is worth trying out
% TODO describe bounds on beta, and why bounds were used (sometimes beta was like over 100 or something
...
% FIXME fix data with new info from zappa03
% FIXME this is only based 
...
%\section{Conclusion}
% The confidence matrices should be made much more significant by using more than one AE for each pair
