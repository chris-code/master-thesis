...
% TODO FIXME mention that AEs were generated based on the preprocessed training data part of GTSRB
...
% Absolutely show confusion matrix for gtsrb, very interesting
% Results of confusion matrix may imply that when taking only the spectra of AEs with a confidence higher than 0.5 or 0.9, some classes get heavily biased. It might make sense to stratify the selection.
